...
class CollisionModel(gm.GeometricModel):
    ...
    def attach_to(self, obj):
        if isinstance(obj, ShowBase):
            ...
            self._objpdnp.reparentTo(obj._objpdnp)
        else:
            print(f"Must be ShowBase, modeling.StaticGeometricModel, GeometricModel, CollisionModel, "
                  f"or CollisionModelCollection!, instead of {type(obj)}")

...
class RackStatePlot:
    ...
    def __init__(self, goal_pattern: RackState,
        ...
        # rack state shape
        self.state_shape = self._goal_pattern.state.shape
        ...
        self.num_classes = np.max(self._goal_pattern.state)
    ...
    def _plot_rack(self, axe):
        goal_pattern_np = self._goal_pattern.state

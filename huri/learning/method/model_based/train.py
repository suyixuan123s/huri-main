...
from huri.learning.method.model_based.net import RangeNet
...
def train_rangenet(args, iteration, new_optim_state):
    # gather data
    logger.info("Loading training data...")
    data_path = fs.workdir_learning / f"datasets/iter_{iteration}/"
    datasets = []
    for idx, file in enumerate(data_path.glob("**/*")):
        datasets.append(fs.load_pickle(file))
...
if __name__ == "__main__":
    train_rangenet(None, 0, new_optim_state=None)

from huri.learning.method.model_based.monte_carlo import run_MCTS
from huri.learning.method.model_based.train import train_rangenet
...
if __name__ == "__main__":
    ...
    for i in range(args.iteration, args.total_iterations):
        ...
        train_rangenet(args, iteration=i, new_optim_state=True)
        if i >= 1:

...
class SelfPlay:
    ...
    def continuous_self_play(self, shared_storage, replay_buffer, test_mode=False):
        ...
        while ray.get(
            ...
            model_weight = ray.get(shared_storage.get_info.remote("weights"))
            ...
            if not test_mode:
                ...
                game_history = self.play_game(
                    ...
                    # single player ignore this param
                    self.config.muzero_player,  # single player ignore this param
                )
    ...
    def play_game(
        ...
        game_history.goal_pattern = self.game.get_goal_pattern()
            ...
            while (
                ...
                if opponent == "self" or muzero_player == self.game.to_play():
                    root, mcts_info = MCTS(self.config).run(
                        ...
                        legal_actions_func=self.game.legal_actions_func,
...
class MCTS:
    ...
    def run(
        ...
        if override_root_with:
            ...
            root = Node(0)
            legal_actions = legal_actions_func(observation)
            observation = (
    ...
    def select_child(self, node, min_max_stats):
        ...
        # Randomly choose an action if multiple actions have the same heuristics
...
if __name__ == "__main__":
    from huri.learning.method.AlphaZero.game.tubeswap import MuZeroConfig, Game
    ...
    sp = SelfPlay(checkpoint, Game, config, seed=777)
    sp.continuous_self_play(shared_storage_worker, replay_buffer_worker)

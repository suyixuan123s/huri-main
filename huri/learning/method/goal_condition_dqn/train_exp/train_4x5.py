import numpy as np
from huri.learning.method.DQN.dqn_r import DQNAgent_r as DQNAgent
...
if __name__ == "__main__":
    ...
    parser.add_argument("--step-num", type=int, default=100000000, help="Step number for learning")
    parser.add_argument("--reset-num", type=int, default=60, help="Reset number for each episode")
    ...
    parser.add_argument("--eps-decay", type=float, default=1e-4, help="epsilon greedy decay rate")
    parser.add_argument("--replay-size", type=int, default=10 ** 7, help="replay buffer size")
    parser.add_argument("--update-freq", type=int, default=2000, help="target network update frequency")
    parser.add_argument("--env-difficulty", type=int, default=2, help="difficulty of the environment")
    ...
    env.goal_pattern = np.array([[1, 1, 2, 2, 3, 3],
                                 [1, 1, 2, 2, 3, 3],
                                 [1, 1, 2, 2, 3, 3],
                                 [1, 1, 2, 2, 3, 3]])
    ...
    net = DuelingDQN(obs_dim=observation_space_dim, action_dim=action_space_dim)

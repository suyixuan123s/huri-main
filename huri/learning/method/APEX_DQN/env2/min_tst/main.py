...
from huri.learning.network.d3qn_attention import DuelingDQNL, DuelingDQNM, DuelingDQNMini, DuelingDQN5, DuelingDQN5Mini
...
if __name__ == "__main__":
    ...
    parser.add_argument("--num-actors", type=int, default=10, help="Number of actors")

...
class Learner(object):
    ...
    def learn(self, T, create_agent, init_dqn_path: str = None, ):
        ...
        for t in range(T):
            ...
            if self.num_dqn_updates % self.target_update_freq:
                self.dqn_target.load_state_dict(self.dqn.state_dict())
...
#         self.optimizer.zero_grad()
#         torch.nn.utils.clip_grad_norm_(self.dqn.parameters, 5)
#         loss.backward()
#         self.optimizer.step()
#         return loss.item()
#
...
#             loss_total += loss
#             if self.num_dqn_updates % 1000 == 0:
#                 print(f"Learner update numbers: {self.num_dqn_updates}, Loss average: {loss_total / 1000}, "
#                       f"Time average is {time_average} ms")
#                 loss_total = 0
#                 time_average = 0

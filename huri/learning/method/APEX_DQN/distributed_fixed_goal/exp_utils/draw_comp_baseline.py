...
if __name__ == '__main__':
    ...
    file_paths = [
        ...
        r'E:\huri_shared\huri\learning\method\APEX_DQN\distributed_fixed_goal\exp\data_efficiency\A_R_2\log\eval_log.csv',
        r'E:\huri_shared\huri\learning\method\APEX_DQN\distributed_fixed_goal\exp\data_efficiency\A_T\log\eval_log.csv',
        # r'E:\huri_shared\huri\learning\method\APEX_DQN\distributed_fixed_goal\exp1\5x10x5_no_reanalyzer\log\eval_log.csv',
    ...
    if False:
        legend = plt.legend(handles=custom_handles, fontsize=legend_size, handlelength=.1, borderpad=0, frameon=True,
                            labelspacing=0,
                            borderaxespad=0.3, loc='lower right')

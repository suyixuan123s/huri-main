...
def plot_time_consumption(data_list, toggle_label=False):
    ...
    plt.xlabel('#Tube', fontsize=font_size)
...
def plot_len_comparison(data_list):
    ...
    plot_average_len(data_time, toggle_label=True)
...
if __name__ == "__main__":
    ...
    # INDEX = 'c'
    plot_len_comparison(
        [r'E:\huri_shared\huri\learning\method\APEX_DQN\distributed_fixed_goal\exp_utils\exp_solution_A\A0',
         r'E:\huri_shared\huri\learning\method\APEX_DQN\distributed_fixed_goal\exp_utils\exp_solution_A\A1',
         r'E:\huri_shared\huri\learning\method\APEX_DQN\distributed_fixed_goal\exp_utils\exp_solution_A\A2',
         r'E:\huri_shared\huri\learning\method\APEX_DQN\distributed_fixed_goal\exp_utils\exp_solution_A\A3'],
    )

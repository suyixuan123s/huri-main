...
if __name__ == '__main__':
    ...
    file_paths = [
        # r'E:\huri_shared\huri\learning\method\APEX_DQN\distributed_fixed_goal\exp1\5x10x5_no_A_star_completer\log\eval_log.csv',
        # r'E:\huri_shared\huri\learning\method\APEX_DQN\distributed_fixed_goal\exp1\5x10x5_no_A_star_refiner\log\eval_log.csv',
        # r'E:\huri_shared\huri\learning\method\APEX_DQN\distributed_fixed_goal\exp1\5x10x5_no_reanalyzer\log\eval_log.csv',
        # r'E:\huri_shared\huri\learning\method\APEX_DQN\distributed_fixed_goal\finished\5x10x5\log\eval_log.csv',
        r'E:\huri_shared\huri\learning\method\APEX_DQN\distributed_fixed_goal\exp\data_efficiency\A_R_T\log\train_log.csv',
        r'E:\huri_shared\huri\learning\method\APEX_DQN\distributed_fixed_goal\exp\data_efficiency\A_R\log\train_log.csv',
        r'E:\huri_shared\huri\learning\method\APEX_DQN\distributed_fixed_goal\exp\data_efficiency\A_T\log\train_log.csv',
        r'E:\huri_shared\huri\learning\method\APEX_DQN\distributed_fixed_goal\exp\data_efficiency\baseline\log\train_log.csv',
        # r'E:\huri_shared\huri\learning\method\APEX_DQN\distributed_fixed_goal\exp1\5x10x5_no_reanalyzer\log\train_log.csv',
        # r'E:\huri_shared\huri\learning\method\APEX_DQN\distributed_fixed_goal\exp1\5x10x5_no_A_star_completer\log\eval_log.csv',
        # r'E:\huri_shared\huri\learning\method\APEX_DQN\distributed_fixed_goal\exp1\5x10x5_no_A_star_refiner\log\eval_log.csv',
        # r'E:\huri_shared\huri\learning\method\APEX_DQN\distributed_fixed_goal\exp1\5x10x5_no_curriculum\log\eval_log.csv'
    ]
    ...
    for i, df in enumerate(dataframes):
        ...
        plt.plot(df['epoch'], df['learner_train_loss'], color=colors[i], label=labels[i],
                 linewidth=5)
    ...
    ax.xaxis.set_major_locator(ticker.MultipleLocator(10000))  # Adjust interval for x-axis

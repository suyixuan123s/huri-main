...
def run_comps(goal_pattern,
    ...
    for training_level, states in state_list.items():
        ...
        if training_level >= seg_len * seg_len_counter or training_level == max(state_list.keys()):
            ...
            save_path = fs.Path(f'eval_results_{save_id}_{training_level_up_index}_{training_level}.pkl')
...
if __name__ == '__main__':
    ...
    solver1_R._net = solver1_R._init_net(
        'E:\huri_shared\huri\learning\method\APEX_DQN\distributed_fixed_goal\exp\data_efficiency\A_R\data\model_best_47.chkpt')

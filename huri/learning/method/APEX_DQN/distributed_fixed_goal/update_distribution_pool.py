...
def update_restore():
    start = fs.Path(r'E:\huri_shared\huri\learning\method\APEX_DQN\distributed_fixed_goal')
    goal = fs.Path(r"E:\learning\huri\learning\method\APEX_DQN\distributed_fixed_goal")

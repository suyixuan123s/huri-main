...
from huri.learning.method.APEX_DQN.distributed.reanalyzer import Reanalyzer, extract_path_from_traj, \
    rm_ras_actions_recur3, RackStatePlot, refined_path_to_transitions_recur, a_star_solve, synthetic_traj, RackState
...
@hydra.main(config_path='../params', config_name='20230517_5x10.yaml', version_base='1.3')
def main(cfg):
    ...
    while True:
        ...
        #     r'E:\huri_shared\huri\learning\method\APEX_DQN\distributed_fixed_goal\test\20231125172016_eval_2.pkl')
        ...
        ##
        # human = fs.load_pickle('human_solution3.pkl')
        # goal_pattern = RackState(np.array([[1, 1, 0, 0, 2, 2, 0, 0, 3, 3],
        #                                    [1, 1, 0, 0, 2, 2, 0, 0, 3, 3],
        #                                    [1, 1, 0, 0, 2, 2, 0, 0, 3, 3],
        #                                    [1, 1, 0, 0, 2, 2, 0, 0, 3, 3],
        #                                    [1, 1, 0, 0, 2, 2, 0, 0, 3, 3]]))
        ...
        ##
        state_list, goal_pattern = fs.load_pickle(
                r'E:\huri_shared\huri\learning\method\APEX_DQN\distributed\run\data\20231125173033_eval_27.pkl')
        ...
        img = rsp.plot_states(state_list, row=5, img_scale=3).get_img()

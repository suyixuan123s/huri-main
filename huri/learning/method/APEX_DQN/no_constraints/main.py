...
from nn.ddqn import DuelingDQNCNN4, DuelingDQNCNN2, DuelingDQNTransformer
...
def create_agent(obs_dim, act_dim, n_classes, device):
    ...
    return DuelingDQNTransformer(obs_dim=obs_dim, action_dim=act_dim, num_classes=n_classes).to(device)

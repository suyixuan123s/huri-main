...
class RealsenseCamera:
    ...
    @classmethod
    def get_table_from_text_data_frame(cls, frame: rs.frame, round_ndigits: int = 2, int_len: int = 3) -> (
    list, rs.frame):
        '''
...
class AllCamerasLoop:
    ...
    @classmethod
    def get_conected_cameras_info(cls, camera_name_suffix: str = 'D405') -> [(str, str)]:
        '''

...
from robot_sim.end_effectors.gripper.lite6_wrs_gripper import Lite6WRSGripper, Lite6WRSGripper2
...
if __name__ == "__main__":
    ...
    gripper_s = Lite6WRSGripper2(enable_cc=True)
    ...
    fs.dump_json(grasp_info_list, save_path.parent.joinpath("lite6_gp2", save_path.name))

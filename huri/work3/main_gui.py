...
from vision_sys import RackLocatorDual, detect_tube, is_pose_err
...
from constants import (TCP2EYE_MAT_DEVICE_1,
...
def init_vision_system(rl, detector, rbtx, add_to_scene_func=None, toggle_debug=False):
    # x_range = np.array([.3])
    ...
    if TOGGLE_VIS_DEBUG:
        fs.dump_pickle([(pcd_1, im_1), (pcd_2, im_2), (pcd_3, im_3), (pcd_4, im_4)], "pcd_data_debug", reminder=False)
...
class Execution(object):
    def __init__(self):
        ...
        grasp_cache_dict = {
            ...
            # white
            2: fs.load_json(path=fs.workdir_data.joinpath("grasps", "lite6_gp2", "white_cap_tube_grasps.json")),
        }  # restore grasps

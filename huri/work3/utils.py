...
def init_env_rbt(toggle_online=True) -> XArmLite6Helper:
    sim_rbt = XArmLite6WRSGripper2()
    if toggle_online:
        rbt_con = XArmLite6X(rbt_s=sim_rbt, has_gripper=True)
    else:
        rbt_con = None

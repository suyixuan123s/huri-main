...
if __name__ == "__main__":
    ...
    pm, jnt_samples, manipuability = load_data(
        # reachability_names=("reachability_db_0.pkl",),
        # jntspace_samples_names=("jntspace_samples_0.pkl",)
    )
    ...
    # [16  6 12  0 48 13]
    ppp = voxelize(pm_f,voxel_size_pos=voxel_size_pos,voxel_size_rot=voxel_size_rot)
    ...
    gm.gen_pointcloud(ppp[:,:3]*voxel_size_pos,pntsize=4).attach_to(base)

...
ANIMATION_SAVE_PATH = fs.Path(r"E:\huri_shared\huri\components\exe\version\animation.pkl")
...
def vision_system(detector: TestTubeDetector,
    ...
    detected_test_tubes, tube_rack, rack_tf = detector.analyze_scene(rack_proto=Rack_Hard_Proto,
                                                                     pcd=pcd,
                                                                     texture_img=img[:, :, 0],
                                                                     std_out=None,
    ...
    # debug_data = {"name": "vision_system",
    #               "data": [pcd, img],
    #               "tube_rack": tube_rack.rack_status,
    #               "rack_tf": rack_tf}

    fs.dump_pickle([uuid.uuid4().hex, pcd, img], r"E:\huri_shared\huri\components\exe\version\vision_data.pkl", reminder=False)
...
def main(open_jaw_width=.034,
    ...
    common_grasp_solver = CommonGraspSolver(num_workers=6)

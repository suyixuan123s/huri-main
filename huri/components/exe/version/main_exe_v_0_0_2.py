...
def vision_system(detector: TestTubeDetector,
    ...
    fs.dump_pickle({'raw_data': [pcd, img, depth_img],
                   ...
                   reminder=False)
    #############
    # fs.dump_pickle([uuid.uuid4().hex, pcd, img], r"E:\huri_shared\huri\components\exe\version\vision_data.pkl",
    #                reminder=False)
            ...
            for _ in range(retry_num):
                ...
                start2pickapproach_motion_seg, pickapproach_motion_seg, pickdepart_motion_seg, \
                    ...
                    pp_planner.gen_pick_and_place_motion(hnd_name=component_name,
                                                         ...
                                                         end_conf=RBT_END_CONF if need_grasp_vision_feedback or (
...
if __name__ == '__main__':
    main(open_jaw_width=.031,
         ...
         depth_sensor_debug_path=None,
         retry_num=5,
         goal_place_offset_dis=.01,
         is_vision_feedback=False,
         toggle_save=True,
         exe_speed=500,
         VISION_FEEDBACK_INTERVAL=1000)

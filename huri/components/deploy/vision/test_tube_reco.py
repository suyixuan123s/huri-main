...
from huri.components.exe.constants import TABLE_HEIGHT, RACK_HEIGHT
...
AFFINE_MAT_PATH = SENSOR_INFO.PNT_CLD_CALIBR_MAT_PATH
DEBUG = False
DEBUG_VISION_DATA_PATH = fs.workdir / "data" / "vision_exp" / "20240326-233942.pkl"
...
def test():
    ...
    if DEBUG:
        ...
        pcd, img, depth_img, _, _ = vision_read_data(DEBUG_VISION_DATA_PATH)
    else:

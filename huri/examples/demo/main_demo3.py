...
from huri.core.file_sys import workdir, load_json
...
if __name__ == "__main__":
    ...
    from huri.components.exe.utils import capture_vision_info
    ...
    if DEBUG:
        filename = workdir / "data" / "vision_exp" / "20220215-154227.pkl"
        pcd, img, depth_img = capture_vision_info(debug_filename=filename,
                                              toggle_debug=DEBUG)
    else:

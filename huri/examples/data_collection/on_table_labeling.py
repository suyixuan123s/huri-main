...
from huri.examples.data_collection.phoxi_calib.utils import project_pcd2extcamimg
from huri.examples.data_collection.utils import SelectRegionBasePhoxiStreamer, img_to_n_channel, Label

CALIB_MAT_PATH = workdir / "data/calibration/qaqqq.json"
SAVE_PATH = workdir / "examples" / "data_collection" / "data" / "bluecap"
TUBE_TYPE = "blue cap"
...
class SelectRegion(SelectRegionBasePhoxiStreamer):
    def __init__(self, showbase,
        ...
        super(SelectRegion, self).__init__(showbase,
                                           param_path="params/params_sr.json",
    ...
    def _render_acquire_data_and_save(self):
        ...
        fs.dump_pickle([self._pcd, self._texture, self._extcam_img, self._depth_img, annotaions],
    ...
    def _update(self, x):
        ...
        if data is None:
            ...
            h_e_1, w_e_1, h_e_2, w_e_2 = h1, w1, h2, w2
            ...
            label_info = Label(label_name=label_name,
                               bbox_depth=(w1, h1, w2, h2),
                               bbox_img=(w_e_1, h_e_1, w_e_2, h_e_2),
                               extracted_pcd_idx=extracted_pcd_idx, )
            labels.append(label_info)
            depth_img_labeled = cv2.rectangle(depth_img_labeled, (w1, h1), (w2, h2),
                                              color=(255, 0, 0), thickness=3)
            img_labeled = cv2.rectangle(img_labeled, (w_e_1, h_e_1), (w_e_2, h_e_2),
                                        color=(255, 0, 0), thickness=3)
            gm.gen_pointcloud(

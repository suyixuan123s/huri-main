...
# indicate object model path and  grasp pose save path
obj_path = "tubebig.stl"
grasppose_savepath = r'./grasps.pkl'

# Generate collision model and attach to the virtual environment
objcm = cm.CollisionModel(obj_path)
...
grasp_info_list = define_grasp_with_rotation(gripper_s,
                                             objcm,
                                             gl_jaw_center_pos=np.array([0, 0, .08]),
                                             gl_jaw_center_z=

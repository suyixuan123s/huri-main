...
class Yumi(ri.RobotInterface):
    ...
    def hold(self, hnd_name, objcm, jaw_width=None):
        ...
        print("cd elements len ", len(self.cc.all_cdelements))
        print("nbit mask:", self.cc.nbitmask)
...
if __name__ == '__main__':
    ...
    yumi_instance.fk("lft_arm",np.zeros(7))
    yumi_meshmodel = yumi_instance.gen_meshmodel(toggle_tcpcs=True, toggle_jntscs=True)

...
import robot_sim.manipulators.dobot_nova2.nova2 as nova2
import robot_sim.end_effectors.gripper.cobotta_gripper.cobotta_gripper as cbtg
import robot_sim.robots.robot_interface as ri


class Nova2(ri.RobotInterface):

    def __init__(self, pos=np.zeros(3), rotmat=np.eye(3), name="nova2", enable_cc=True):

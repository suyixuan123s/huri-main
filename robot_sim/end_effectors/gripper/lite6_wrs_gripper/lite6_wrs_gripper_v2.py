...
class Lite6WRSGripper2(gp.GripperInterface):
    ...
    def _finger_cdnp(name, radius):
        ...
        collision_primitive_c0 = CollisionBox(Point3(0.015, 0.01, .025),
                                              x=.005 + radius, y=0.005 + radius, z=.025 + radius)
        collision_node.addSolid(collision_primitive_c0)
        collision_primitive_c1 = CollisionBox(Point3(0.015, 0.011, 0.065),
                                              x=.005 + radius, y=0.004 + radius, z=.015 + radius)
        collision_node.addSolid(collision_primitive_c1)
        collision_primitive_c2 = CollisionBox(Point3(0.015, 0.0075, .082 + .0115),
                                              x=.005 + radius, y=0.0025 + radius, z=.0115 + radius)
        collision_node.addSolid(collision_primitive_c2)
        collision_primitive_c3 = CollisionBox(Point3(0.015, 0.006, 0.105 + .0135),
                                              x=.005 + radius, y=0.001 + radius, z=.0135 + radius)

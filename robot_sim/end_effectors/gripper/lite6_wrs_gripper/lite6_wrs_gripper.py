...
class Lite6WRSGripper(gp.GripperInterface):
    ...
    def __init__(self, pos=np.zeros(3), rotmat=np.eye(3), cdmesh_type='convex_hull', name='lite6_wrs_gripper',
        ...
        self.lft.lnks[0]['loc_rotmat'] = rm.rotmat_from_euler(0, 0, math.pi / 2)
        ...
        self.lft.jnts[1]['loc_pos'] = np.array([0.0040, 0, 0.089 + .005])
        self.lft.jnts[1]['loc_rotmat'] = rm.rotmat_from_euler(0, 0, math.pi / 2)
        ...
        self.rgt.jnts[1]['loc_pos'] = np.array([-0.0040, 0, 0.089 + .005])

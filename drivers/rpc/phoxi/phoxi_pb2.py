...
_PHOXISETTINGS = _descriptor.Descriptor(
  name='PhoxiSettings',
  full_name='PhoxiSettings',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='ledpower', full_name='PhoxiSettings.ledpower', index=0,
...
DESCRIPTOR.message_types_by_name['PhoxiSettings'] = _PHOXISETTINGS
...
PhoxiSettings = _reflection.GeneratedProtocolMessageType('PhoxiSettings', (_message.Message,), {
  'DESCRIPTOR' : _PHOXISETTINGS,
  '__module__' : 'phoxi_pb2'
  # @@protoc_insertion_point(class_scope:PhoxiSettings)
  })
_sym_db.RegisterMessage(PhoxiSettings)
...
_PHOXI = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='getrgbtextureimg',
    full_name='Phoxi.getrgbtextureimg',
    index=5,
    containing_service=None,
    input_type=_EMPTY,
    output_type=_CAMIMG,
  ...
  _descriptor.MethodDescriptor(
    name='changeledpower',
    full_name='Phoxi.changeledpower',
    index=7,
    containing_service=None,
    input_type=_PHOXISETTINGS,
    output_type=_EMPTY,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
